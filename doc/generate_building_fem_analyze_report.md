...
- [概要](#概要)
- [ファイル構造](#ファイル構造)
  - [1. ヘッダー部（1-75行）](#1-ヘッダー部1-75行)
  - [2. データクラス定義（189-205行）](#2-データクラス定義189-205行)
  - [3. 屋根関連関数（211-491行）](#3-屋根関連関数211-491行)
- [関数コール構造](#関数コール構造)
  - [1. メインエントリーポイント](#1-メインエントリーポイント)
  - [2. ユーティリティ関数](#2-ユーティリティ関数)
- [パラメータから建物を作るプロセス](#パラメータから建物を作るプロセス)
  - [1. パラメータの準備](#1-パラメータの準備)
  - [2. 建物生成の詳細な流れ](#2-建物生成の詳細な流れ)
  - [3. 3Dモデルの構成要素](#3-3dモデルの構成要素)
- [評価プロセス](#評価プロセス)
  - [1. FEM解析](#1-fem解析)
  - [2. 評価指標の計算](#2-評価指標の計算)
  - [3. 結果の返却](#3-結果の返却)
