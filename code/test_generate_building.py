...
default_params = {
    ...
    # その他の設計パラメータ
    'wall_tilt_angle': -25,      # 壁傾斜角（垂直）
    'window_ratio_2f': 0.7,      # 2階窓面積比
    'roof_morph': 0.9,           # 屋根形態（標準）
    'roof_shift': 0.7,           # 屋根シフト（対称）
    'balcony_depth': 1.8         # バルコニー奥行（控えめに）
}
