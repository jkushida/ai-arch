...
PARAM_RANGES = {
    ...
    # 構造部材寸法
    "tf": (180, 500),           # 床スラブ厚: 180-450mm
    "tr": (150, 400),           # 屋根スラブ厚: 150-350mm
    "bc": (300, 900),           # 柱幅: 300-850mm
    "hc": (300, 800),           # 柱高さ: 300-750mm
    "tw_ext": (150, 350),       # 外壁厚: 150-320mm
        ...
        for future in concurrent.futures.as_completed(futures):
            ...
            try:
                ...
                error_row = {
                    ...
                    "material_columns": original_dv_for_error.get("material_columns", 0),
                    "material_floor1": original_dv_for_error.get("material_floor1", 0),
                    "material_floor2": original_dv_for_error.get("material_floor2", 0),
                    "material_roof": original_dv_for_error.get("material_roof", 0),
                    "material_walls": original_dv_for_error.get("material_walls", 0),
                    "material_balcony": original_dv_for_error.get("material_balcony", 0),
                    "cost_per_sqm": float("nan"),
                    "co2_per_sqm": float("nan"),
                    "comfort_score": float("nan"),
                    "constructability_score": float("nan"),
